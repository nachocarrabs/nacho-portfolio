          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="habilidades" className="w-full h-full">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:gap-[20px] gap-3">
                  {skills.skillList.map((skill, index) =>{
                    return <li key={index}>
                      <TooltipProvider delayDuration={100}>
                        <Tooltip>
                          <TooltipTrigger className="w-full h-[100px] bg-[#232329] rounded-xl flex justify-center items-center group hover:border  hover:border-accent transition-all duration-300">
                          <div className="text-4xl hover:text-accent transition-all duration-300">{skill.icon}</div>
                          </TooltipTrigger>
                          <TooltipContent>
